...
mean strict. This follows the other compatibility flag of this shape in this
repo, for the same reason: the safe value has to be the one you get by doing
nothing, saying nothing, and misspelling it.
