      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="eval-dataset-actions">
            ...
            {datasetState === 'saving' ? (
              <AdaptLoader variant="inline" label="Saving dataset" className="settings-row-note" />
            ) : null}
          </div>
        ...
        <CardContent>
          ...
          <div className="eval-dataset-actions">
            ...
            <Button type="button" variant="outline" onClick={() => void scoreLastThread()} disabled={threadScoring}>
              <AdaptBusyButtonContent busy={threadScoring} label="Score last Ask thread" busyLabel="Scoring…" />
            </Button>
          </div>
