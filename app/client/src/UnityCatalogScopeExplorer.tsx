...
function ExplorerNode({
  ...
  const rowState = scopeState(resourceType, value);
  ...
  return (
    <li
      ...
      role="treeitem"
      data-connected={!rowState.selectable ? 'true' : undefined}
        ...
        <header className="uc-explorer-header">
          <div>
            ...
            <p id="uc-explorer-description">
              Declaring an asset records intended scope only. It does not grant Unity Catalog permissions or change the
              deployed model. Live Genie curation remains the model manifest source of truth until the agent is logged
              again.
            </p>
          </div>
          <Button
