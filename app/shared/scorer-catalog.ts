...
export const SECOND_IDENTITY_ABSENT =
  'This deployment has no second signed-in user credential to run the mismatch check with. Running the ' +
  'check under the same credential twice would produce a green result that is evidence of nothing.';
...
export const SCORER_CATALOG: readonly ScorerDefinition[] = [
  ...
  },
  {
    ...
    blockedReason: SECOND_IDENTITY_ABSENT,
    gating: false,
  },
  {
    id: 'coverage_caveat',
