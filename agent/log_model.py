...
experiment = os.getenv("PLAYER_INSIGHTS_EXPERIMENT", "/Shared/adapt-genie")
model_name = os.getenv(
    "PLAYER_INSIGHTS_MODEL_NAME",
    f"{settings.catalog}.{settings.schema}.adapt_orchestrator",
)
...
print(f"Genie title: data={data_genie_title!r}")
...
# The evidence escape valve is resolved and announced
...
with mlflow.start_run(run_name="log_adapt_orchestrator"):
