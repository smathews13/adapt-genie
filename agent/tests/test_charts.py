...
class TestLongCategoryNames:
    ...
    def test_a_long_name_is_broken_over_lines_rather_than_left_as_one_string(self):
        ...
        # A name long enough to need it is broken across lines rather than left
        # as one string that would stretch the axis.
        assert chart.data[0]["x"][3] == "Outfit: Old<br>Harbor"
        # A short name is left exactly as it arrived.
        assert chart.data[0]["x"][2] == "Dynasty VII"
