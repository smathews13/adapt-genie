...
import { billingTagPair } from '../../shared/billing-tag';
import { recordAdminAction } from '../lib/admin-roles';
import { applyAdaptTags, type ResourceTagSummary } from '../lib/resource-tagging';
...
export function setupResourceTagRoutes(appkit: InsightsAppKit, dependencies: ResourceTagRouteDependencies): void {
  const apply = dependencies.apply ?? applyAdaptTags;
