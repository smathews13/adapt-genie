...
describe('the Monitoring list over a 100,000-message store', () => {
  it('serves the all-time range from the page rather than the store', async () => {
    ...
    // Three round trips for the whole page: app-group settings, the
    // page-and-totals statement, and the ledger. The large-store query itself
    // remains one statement rather than splitting page, totals, and people.
