  ...
  return (
    <div className="ops-app-budget-guard" data-budget-level={status.level}>
      ...
      {admin && status.level === 'approval-required' ? (
        ...
        >
          <AdaptBusyButtonContent busy={busy === 'approve'} label="Approve continued usage" busyLabel="Approving" />
        </Button>
      ) : null}
      {admin && status.level === 'approved-overage' ? (
        ...
        >
          <AdaptBusyButtonContent busy={busy === 'revoke'} label="Revoke approval" busyLabel="Revoking" />
        </Button>
      ) : null}
      {failure ? (
...
export function CostBudgetApplyButton({
  ...
  return (
    <Button
      ...
      onClick={onClick}
    >
      <AdaptBusyButtonContent busy={saving} label={text} busyLabel="Applying" />
    </Button>
  );
}
