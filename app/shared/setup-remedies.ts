 ...
 * the compatibility schema. On restart the app creates `adapt` itself and is
...
export const GRANT_SCRIPT_WHY =
  ...
  'principal, then restart; the app creates and owns its `adapt` schema. The app service principal ' +
