...
import { LIVE_SCORE_KEEP, parseLiveTraceScore, type LiveTraceScore } from '../../shared/eval-live-scoring';
...
export async function appendLiveScore(client: LakebaseReader, score: LiveTraceScore): Promise<LiveTraceScore> {
