 ...
 * that can support it.
 *
 * THE FAILURE THIS ANSWERS. Several Connections rows read 403 for a reader who
 * could query every one of those objects
 ...
 * the token's scope claim and the deployment's compatibility scope variable.
 * Declared scopes are target-layered and have been spelled
 ...
 * Catalog and workspace browse shortfalls are optional for this
