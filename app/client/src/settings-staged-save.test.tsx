...
describe('staged Settings saves', () => {
  it('stages Forecasting, marks one unsaved change, and enables Save', () => {
    const draft = withExperimentalFeature({ ...NO_EXPERIMENTS }, 'forecasting', !NO_EXPERIMENTS.forecasting);
  ...
  it('counts each key once after repeated edits and returns to clean when reverted', () => {
    const toggled = !NO_EXPERIMENTS.forecasting;
    const first = withExperimentalFeature({ ...NO_EXPERIMENTS }, 'forecasting', toggled);
    const editedAgain = withExperimentalFeature(first, 'forecasting', toggled);
    const reverted = withExperimentalFeature(editedAgain, 'forecasting', NO_EXPERIMENTS.forecasting);
