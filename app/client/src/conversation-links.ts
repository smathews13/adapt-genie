/**
 * Where a link into ADAPT Ask points, and how one answer inside a thread is named.
 *
 ...
 * `/?conversation=<id>`; ADAPT Ask has only ever read `?c=`. Nothing failed
 ...
 * parameter in the other direction -- ADAPT Ask to Run Explorer, see Layout.tsx --
...
/** Search parameter the ADAPT Ask screen reads to open one conversation. */
export const CONVERSATION_PARAM = 'c';

/** Search parameter ADAPT Ask reads to bring one answer in that thread into view. */
