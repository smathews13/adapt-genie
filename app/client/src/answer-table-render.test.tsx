...
describe('the table is styled as part of the answer, not as a new design', () => {
  ...
  it('keeps the polished ledger as default and makes plain an explicit opt-out', () => {
    expect(ANSWER_CSS).toContain("html[data-table-style='plain'] .answer-table-frame");
    expect(ANSWER_CSS).toContain("html[data-table-style='plain'] .answer-table thead th");
    expect(ANSWER_CSS).not.toContain("html[data-table-style='polished']");
  });
