 ...
 * an optional-resource row did it again with an eleven-line shell snippet attached.
 *
 ...
 * required finding read "Optional resource, Refused" with the permission it was
