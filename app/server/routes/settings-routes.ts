 ...
 * and the declared table list. Those come from the app
...
async function readReachability(
  ...
  try {
    ...
    // It starts with the user-scoped probes so their shared deadline cannot expire
 ...
 * failure that matters here is a lost grant on the compatibility schema, which a
