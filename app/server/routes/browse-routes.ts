 ...
 * spaces, model serving endpoints, and Lakebase projects/branches/databases
 * under the forwarded user token. Catalog, notebook, and Lakebase browse return a distinct unavailable outcome when their
