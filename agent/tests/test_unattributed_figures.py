...
def test_the_module_is_named_for_its_consequence_not_its_mechanism():
    ...
    Somebody typing the compatibility switch has to read what it does on the way
    past. RELAX_GENIE_VALIDATION or PERMISSIVE_GATEWAY sound like tuning, and
    tuning gets turned on to see if it helps.
    """
