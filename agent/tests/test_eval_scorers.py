...
class TestEntityRecall:
    ...
    def test_removed_packaging_metric_is_not_reported(self):
        assert "stale_index" not in {scorer.name for scorer in scorers.REPORTING_SCORERS}
