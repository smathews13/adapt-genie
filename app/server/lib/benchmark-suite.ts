 ...
 * Unity Catalog data is regenerated periodically, and an expectation like "GTA
...
export const BENCHMARK_CASE_CATALOG: readonly BenchmarkCaseDefinition[] = [
  ...
  },
  {
    ...
    guidelines: ['The answer presents active players broken down by both label and title.'],
