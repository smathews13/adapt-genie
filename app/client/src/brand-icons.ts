...
// substituted for the ADAPT palette, and the app draws those. Sam Mathews
...
/** The products ADAPT has an official mark for. */
...
/** The artwork the app draws: official geometry with ADAPT fills. */
 ...
 * The ADAPT design specification forbids orange in the palette. The full-color
