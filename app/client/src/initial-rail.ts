/**
 * The two reads ADAPT Ask makes when it opens: the conversation list the rail is
...
export type ConversationList = Pick<InitialRail, 'conversations' | 'matchingConversationIds' | 'availability'>;
 ...
 * `initial-rail.test.ts` case that pins ADAPT Ask off this function. `Promise.all`
