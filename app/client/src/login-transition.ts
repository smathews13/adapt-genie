 ...
 * from the reference; the design export this repository carries stops at anchor
 ...
 * they live in first-open.css rather than in the ADAPT compatibility animation partial --
 * the keyframe test holds that partial equal to the reference value for
 ...
 * `aria-live="polite"` string, announced once with the ADAPT name.
 */
export const LANDED_ANNOUNCEMENT = 'Signed in. Ask ADAPT is ready.';
