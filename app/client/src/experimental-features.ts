...
/** Whether the deployment exposes its experimental Genie Code / Genie MCP integration. */
export function showsGenieCodeMcp(features: ExperimentalFeatures): boolean {
