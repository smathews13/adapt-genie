 ...
 *
 * Split out of App.tsx when the pages became modules. ADAPT Ask draws it in the
 ...
 * the ADAPT live-agent-path handoff, which is where its
 ...
 * The ADAPT design specification settles it and lists the orange robot among
...
/**
 * The rail's 13px mark: the ADAPT mark, or the tool family's glyph.
 *
 * The compatibility-named `AstrolabeMark` is the ADAPT drawing used by the map's kind chip. Its
 * ink comes from the component's `ink` prop and compatibility stylesheet behind it,
 * so this seating cannot be a second, slightly different ADAPT blue. `light`
 ...
 * a long tool name with its final character alone on a second line.
 *
