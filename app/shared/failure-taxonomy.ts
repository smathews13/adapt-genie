...
export const FAILURE_TAXONOMY: Record<FailureCode, FailureDefinition> = {
  ...
  STREAM_INTERRUPTED: {
    ...
    retryable: true,
    mayRerouteOrReidentify: false,
    uiMessage: 'The connection dropped before the answer finished. The steps that ran are kept.',
    trace: 'record_failure',
    alert: 'info',
    mayGenerateAnswer: false,
  },
  RUN_DEADLINE_EXCEEDED: {
    ...
    retryable: true,
    mayRerouteOrReidentify: false,
    uiMessage: 'This took longer than the time allowed, so it was stopped without a finished answer.',
    trace: 'record_failure',
    alert: 'warning',
    mayGenerateAnswer: false,
  },
