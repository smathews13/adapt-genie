# The ADAPT marks and recoloured product icons

Where these came from, what may be done to them, and the two things about them
that are broken on arrival.

Source: the ADAPT design handoff and asset manifest. Compatibility filenames
retain the `astrolabe-*` prefix.

## `astrolabe-*.svg`: ADAPT mark compatibility assets
...
The d-pad is the canonical ADAPT mark and the other three are archive concepts.
...
is permitted.** Sam Mathews ruled on 2026-08-17. This is a Databricks-built
...
the ADAPT design handoff required the recolour app-wide.
