...
export const CONNECTED_RESOURCES: ConnectedResource[] = [
  ...
  },
  {
    ...
    appEnvVar: 'PLAYER_INSIGHTS_DATA_GENIE_ID',
  ...
  },
  {
    ...
    appEnvVar: 'DATABRICKS_SQL_WAREHOUSE_ID',
  ...
  },
  {
    ...
    agentKey: 'catalog',
    appEnvVar: 'PLAYER_INSIGHTS_CATALOG',
    actualFromCheck: null,
    namesRemoteObject: true,
    applyWith: AGENT_RELEASE,
    stageable: true,
  },
  {
    ...
    agentKey: 'schema',
    appEnvVar: 'PLAYER_INSIGHTS_SCHEMA',
    actualFromCheck: null,
    namesRemoteObject: true,
    applyWith: AGENT_RELEASE,
    stageable: true,
  ...
  },
  {
    ...
    changedBy: 'app-redeploy',
    arrivesBy:
      'The compatibility schema variable, resolved from var.lakebase_app_schema at release time. ' +
      'A source-only Git deploy maps its historical compatibility value to the app-owned adapt ' +
      'schema. Created by the app on boot; bundle targets keep their configured schema.',
