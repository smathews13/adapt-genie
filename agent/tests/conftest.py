...
`agent.py` builds the model at module scope, so importing it resolves settings,
and settings do not default to anything. A test run states its own configuration
here.
