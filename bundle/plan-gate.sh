...
# not come back: `schemas.adapt_telemetry_schema` holds app history that does not
# backfill. It carries `prevent_destroy`, which stops `bundle destroy` -- it does
...
PLAN_JSON=""
PLAN_ERR="$(mktemp "${TMPDIR:-/tmp}/adapt-plan-err.XXXXXX")"
