...
export const LEGACY_NIGHT_ENTITY_STYLES: RuntimeEntityStyles = {
...
export const TABLE_STYLE_IDS = ['polished', 'plain'] as const;
...
export function parsePersistedRuntimeSettings(value: unknown): RuntimeSettings | null {
  ...
  const tableStyle = oneOf(root.tableStyle === undefined ? 'polished' : root.tableStyle, TABLE_STYLE_IDS);
  const fontBodyColor =
