...
def semantic_recall(outputs, expectations) -> Feedback:
    ...
    RECALL OVER ONE LABELLED ENTITY. It is not precision and does not grade how
    the entity was found. A case passes when the published source names or SQL
    reach the expected entity.
    """
