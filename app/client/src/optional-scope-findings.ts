 ...
 *
 * WHAT THIS CORRECTS. The Connections panel is headed "What to fix" and once
 * drew a block for every refused optional browse check. ADAPT does not need the
 * app's forwarded token to carry optional catalog and workspace browse scopes,
 * so the login gate, Identity card, and Connections page all draw those
 * shortfalls neutrally.
 *
