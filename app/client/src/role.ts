 ...
 *
 * The Admin line names Monitoring, Ops, Connections and Settings and NOT Benchmark Lab.
 ...
 */
const CONSUMER_NAV: readonly NavEntry[] = [{ to: '/', label: 'Ask' }];
...
/**
 * Whether the gear is drawn. Every resolved signed-in role can customize its
 * own Appearance and Insights preferences. A failed or unresolved role still
 ...
 * the ADAPT design's account cluster, with the signed-in chip restored in
 ...
 *
 * They are moved to ADAPT Ask with this sentence, because four things have just
