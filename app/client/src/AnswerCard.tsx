 ...
 *
 * Split out of App.tsx when the pages became modules. ADAPT Ask is its only
 * caller, and the card is the largest thing in the transcript, so it is the one
 * most worth being able to work on without holding the whole ask surface open.
 *
...
export function AnswerCard({
   ...
   *
   * True by default: ADAPT Ask and Monitoring both mount this card as the whole
  ...
  const content = stripToolCallDumps(readerAnswer.content ?? '');
    ...
    <Card className="answer-card" id={id}>
      ...
      <CardContent className="answer-card-content">
        ...
        <SourcesModule
          ...
          hideWorkspaceLinks={evidenceLinkedSourceNames(narrative, content, readerAnswer.charts, readerAnswer.sources)}
        />
