 ...
 * been running the cmeg target's "true". The rail narrowed to the reader's own
...
const TABLE = `${APP_SCHEMA}.deployment_decisions`;
...
const release = { PLAYER_INSIGHTS_TARGET: 'cmeg', LAKEBASE_ENDPOINT: 'projects/x/branches/production' };
