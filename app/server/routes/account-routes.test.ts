...
describe('Databricks Apps link', () => {
  it('uses the configured workspace and never guesses one', () => {
    ...
    expect(
      workspaceAppsHref({ DATABRICKS_HOST: 'workspace.example.com', DATABRICKS_WORKSPACE_ID: '7474656585748611' })
    ).toBe('https://workspace.example.com/apps-v2?o=7474656585748611');
