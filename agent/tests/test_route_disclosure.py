...
the Genie space selected for the question, was not.
...
def test_a_second_genie_call_after_a_genie_failure_is_not_a_substitution():
    ...
    the answer left the selected Genie route when it did not.
    """
...
def test_the_caveat_names_both_routes_and_does_not_overclaim_the_damage():
    ...
    assert "Genie space selected" in caveat, "the caveat must name what changed"
