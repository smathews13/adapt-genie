...
const SEMANTIC_TOOLS = new Set(['search_tagged_assets']);
...
/** `[table] catalog.schema.object (uncertified, Rockstar)` */
 ...
 * search, and a reader deciding whether a thin result means sparse governed data
 * needs them.
 *
