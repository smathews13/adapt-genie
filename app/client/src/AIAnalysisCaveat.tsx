...
/** The one reader-facing caveat used wherever ADAPT presents AI analysis. */
export const AI_ANALYSIS_CAVEAT = 'ADAPT analysis. AI can make mistakes.';

/**
 * Quiet product mark and caveat, with no provenance or run-specific text mixed in.
 *
 * The mark is decorative because the adjacent sentence names ADAPT. Keeping
